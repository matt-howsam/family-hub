...
export const PEOPLE = {
  ...
  // dob powers the holiday module's "ages in every slot" line (§7.6) —
  // computed forward from a real birthdate, never a hardcoded age that
  // would silently go stale. Adults don't need one: that feature is about
  // how many holidays are left while the kids still live at home.
  rose:  { id: 'rose',  name: 'Rose',  initial: 'R', kind: 'child', year: 7, tint: 'rose', endsAt: '3:20', dob: '2013-05-08' },
  tom:   { id: 'tom',   name: 'Tom',   initial: 'T', kind: 'child', year: 6, tint: 'tom', endsAt: 'Met 3:10', dob: '2015-01-14' },
};
