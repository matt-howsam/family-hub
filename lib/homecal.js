...
/** Local calendar date (YYYY-MM-DD) for an instant, in the household's zone.
    Exported for lib/whatson.js's item-table adapter, which needs the exact
    same date/time derivation calendar entries already use — never a second,
...
export function localTime(d, tz = TZ) {
