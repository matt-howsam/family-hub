 ...
 * — the real routing signal, per the correction above. Extend as other
 * adults' forwarding addresses are confirmed (Renée's isn't yet).
 */
const FORWARDING_SENDERS = ['matthowsam@me.com'];
